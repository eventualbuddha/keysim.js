...
export class Keyboard {
   ...
   */
  dispatchEventsForKeystroke(keystroke, target, transitionModifiers=true, events) {
    if (!events) {
   ...
   * @private
   */
  dispatchModifierStateTransition(target, fromModifierState, toModifierState, events) {
    if (!events) {
      events = { keydown: true, keypress: true, keyup: true };
    }
